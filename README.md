...
Below is the updated README.md code. It incorporates the detailed mathematical analysis for SMC, LQR, and MRAC controllers, as well as the full Lyapunov Stability Analysis for the ASMC as requested.
